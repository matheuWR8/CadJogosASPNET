...
as 
begin
	update categorias set descricao = @descricao, imagem = @imagem where id = @id
end
GO

ALTER procedure [dbo].[spInsert_Categorias]
(
	@id int,
	@descricao varchar(max),
	@imagem varbinary(max)
...
as 
begin
	insert into categorias (id, descricao, imagem) values (@id, @descricao, @imagem)
end
GO
